...
const swiper = new Swiper('.swiper', {
  ...
  slidesPerView: "auto",
  coverflowEffect: {
    rotate: 0, // Manter a rotação a 0 para evitar inclinações
    stretch: 10, // Diminui o espaçamento horizontal entre os slides para se aproximarem mais
    depth: 150, // Ajuste da profundidade para controlar a "distância" do slide ao centro
    modifier: 2.5, // Controla a intensidade do efeito coverflow
    slideShadows: true, // Mantém as sombras dos slides
  },
  pagination: {
    el: '.swiper-pagination',
    clickable: true,
